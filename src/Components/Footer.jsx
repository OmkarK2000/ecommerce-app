    ...
    <footer className="text-gray-600 body-font border border-t-2">
        ...
        <div className="flex flex-wrap md:text-left text-center justify-center">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <Link  className="text-gray-600 hover:text-gray-800 uppercase">Electronics</Link>
              </li>
              <li>
                <Link className="text-gray-600 hover:text-gray-800 uppercase">Jewelery</Link>
              </li>
              <li>
                <Link className="text-gray-600 hover:text-gray-800 uppercase">Mens Clothing</Link>
              </li>
              <li>
                <Link className="text-gray-600 hover:text-gray-800 uppercase">Womens Clothing</Link>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="bg-gray-100">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          ...
          <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2020 Flash Store —
            <Link href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@OmkarKardile</Link>
          </p>
