        ...
        <div className="flex flex-wrap -m-4">
          {
            products.map((product) => {
              ...
              return (
                <Link to={`/products/${id}`} className="lg:w-1/4 md:w-1/2 p-4 w-full border border-opacity-50 cursor-pointer" key={id}>
                  ...
                  <div className="mt-4">
                    ...
                    <p className="mt-1 text-base font-normal">${price}</p>
                  </div>
                </Link>
              )
